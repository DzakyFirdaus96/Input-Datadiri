...
<form action="input-datadiri-tambah.php" method="POST">
      ...
      <br>
      <input class="btn btn btn-sm btn-success" type="submit" name="simpan" value="Simpan Data" />
      <a class="btn btn btn-sm btn-secondary" href="input-datadiri.php">Kembali</a>
</form>
</div>
